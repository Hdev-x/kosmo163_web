...
public class DepartmentUpdateController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		departmentDTO.setDepartmentId(Integer.parseInt(request.getParameter("departmentId")));
		departmentDTO.setDepartmentName(request.getParameter("departmentName"));
		departmentDTO.setManagerId(Integer.parseInt(request.getParameter("managerId")));
		departmentDTO.setLocationId(Integer.parseInt(request.getParameter("locationId")));
